...
Each subagent prompt: "Read /tmp/codex-ctx-<slug>.md first. Review: <assigned dimensions listed explicitly>. Report: blocking issues (File:Line — issue — why — fix), non-blocking issues, positives."
