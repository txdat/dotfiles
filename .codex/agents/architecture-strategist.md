...
1. Read CODEX.md — architecture patterns, tech stack, constraints
...
If feature scope is ambiguous between architecture and feature — state assumptions and proceed; ask only if decision risk is high.
