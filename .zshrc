...
extend_display () {
    ...
    xrandr --output $display --scale 2x2 && xrandr --output $display --scale ${scale}x${scale} --$direction eDP && xrandr --output eDP --scale 0.9999x0.9999 && xrandr --output $display --set TearFree on
}
