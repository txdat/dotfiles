...
(autothemer-deftheme
 ...
 ((((class color) (min-colors #xFFFFFF))        ; col 1 GUI/24bit
  ...
  (fujiWhite         "#ECF0C1" "#FFFFFF")
  (old-white         "#ECF0C1" "#FFFFFF")

  ;; (sumiInk-0         "#16161D" "#000000")
  ;; (sumiInk-1b        "#181820" "#000000")
  ;; (sumiInk-1         "#1F1F28" "#080808")
  (sumiInk-0         "#0F111B" "#000000")
  (sumiInk-1b        "#0F111B" "#000000")
  (sumiInk-1         "#0F111B" "#080808")
 ...
 (
  ...
  (mode-line                                     (:background sumiInk-2))
  (mode-line-inactive                            (:background nil :foreground sumiInk-4 :bold nil))
  (mode-line-active                              (:background sumiInk-2 :foreground old-white :bold nil))
