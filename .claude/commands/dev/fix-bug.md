...
Spawn `code-explorer` per hypothesis: "Read /tmp/claude-ctx-<slug>.md. Investigate: <N — description>. Verdict: CONFIRMED / ELIMINATED / INCONCLUSIVE. If CONFIRMED: file:line, why."
